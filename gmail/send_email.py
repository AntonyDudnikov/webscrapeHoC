...
def send_email():
    ...
    email_content += f"""</ul><p>Here is your Pierre quote of the day: "{random.choice(poilievre_quotes)}"<br><p>Have a great day!</p>"""
    message = MIMEMultipart('alternative')
    message['Subject'] = f"PERSONAL: Today's News Scan"
    message['From'] = EMAIL
    #change to receiver 
